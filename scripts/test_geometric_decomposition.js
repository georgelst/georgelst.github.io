...
assert.ok(toolJs.includes('aerodynamic_model_equations=51-54') && toolJs.includes('function aerodynamicAlphaGrid(minDegrees = 0, maxDegrees = 40') && toolJs.includes("xMin: 0, xMax: 40, xlabel: 'α (deg)'"), 'Downloaded data and plots must use the requested 0-40 degree alpha range.');
...
assert.ok(toolHtml.includes('v=20260710-aero-polars-toggle'), 'The page must load the aerodynamic-polar toggle script version.');
